...
app.use("/auth",authRouter);app.use("/projects",projectRouter);app.use("/projects/:projectId/tasks",projectTaskRouter);app.use("/tasks",taskRouter);app.use("/jobs",jobRouter);
